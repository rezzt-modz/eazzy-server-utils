...
/**
 * Precompiled unimined-neoforge script plugin.
 **/
@SuppressWarnings("DefaultPackage")
public class UniminedNeoforgePlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_UniminedNeoforge").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("minecraft");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_UniminedNeoforge").asSubclass(BasicScript.class);
