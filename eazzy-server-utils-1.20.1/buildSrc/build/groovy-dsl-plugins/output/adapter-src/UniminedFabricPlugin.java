...
/**
 * Precompiled unimined-fabric script plugin.
 **/
@SuppressWarnings("DefaultPackage")
public class UniminedFabricPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_UniminedFabric").asSubclass(BasicScript.class);
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_UniminedFabric").asSubclass(BasicScript.class);
