...
/**
 * Precompiled common script plugin.
 **/
@SuppressWarnings("DefaultPackage")
public class CommonPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_Common").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("xyz.wagyourtail.manifold");
            target.getPluginManager().apply("xyz.wagyourtail.jvmdowngrader");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_Common").asSubclass(BasicScript.class);
