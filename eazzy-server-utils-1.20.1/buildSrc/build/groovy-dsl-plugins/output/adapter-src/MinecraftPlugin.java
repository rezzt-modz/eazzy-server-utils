...
/**
 * Precompiled minecraft script plugin.
 **/
@SuppressWarnings("DefaultPackage")
public class MinecraftPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_Minecraft").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("common");
            target.getPluginManager().apply("xyz.wagyourtail.unimined");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_Minecraft").asSubclass(BasicScript.class);
